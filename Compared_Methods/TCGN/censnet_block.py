...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features_v, out_features_v, in_features_e, out_features_e, bias=True, node_layer=True,device='cuda:0'):
    ...
    def forward_single_batch(self, H_v, H_e, adj_e, adj_v, T):
        if self.node_layer:
            ...
            mask1 = torch.eye(multiplier1.shape[0]).to(self.device)
...
class GCN(nn.Module):
    def __init__(self,nfeat_v, nfeat_e, nhid, nfeat_v_out, dropout,device='cuda:0'):
        super(GCN, self).__init__()
        self.gc1 = GraphConvolution(nfeat_v, nhid, nfeat_e, nfeat_e, node_layer=True,device=device)
        self.gc2 = GraphConvolution(nhid, nhid, nfeat_e, nfeat_e*2, node_layer=False,device=device)
        self.gc3 = GraphConvolution(nhid, nfeat_v_out, nfeat_e*2, nfeat_e*2, node_layer=True,device=device)
